                                    ...
                                    <MDBCard className="mx-auto px-5 mb-5">
                                        ...
                                        }
                                        {
                                            ...
                                            <div className="px-5 pt-4 pb-5">
                                                ...
                                                <MDBRow className="px-5 my-0 mx-auto d-flex justify-content-center">
                                                    <MDBCol xs="12" lg="10">
                                                ...
                                                <MDBRow className="my-0 px-0 py-0 d-flex justify-content-center">
                                                    <MDBCol xs="12" lg="5" className="my-0">
                                        ...
                                        }
                                        {
                                            ...
                                            <>
                                                ...
                                                <GridVertical productName={"All"} data={product} />
                                            </>
                                        }
                                    </MDBCard>
                                </MDBRow >
